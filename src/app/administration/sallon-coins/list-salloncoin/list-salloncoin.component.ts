...
@Component({
  selector: 'app-list-salloncoin',
  templateUrl: './list-salloncoin.component.html',
  styleUrls: ['./list-salloncoin.component.css']
})
export class ListSalloncoinComponent implements OnInit {

...
@Component({
  selector: 'app-add-salloncoin',
  templateUrl: './add-salloncoin.component.html',
  styleUrls: ['./add-salloncoin.component.css']
})
export class AddSalloncoinComponent implements OnInit {
  addForm!: FormGroup; 
  categList:any=[];

...
@Component({
  selector: 'app-edit-salloncoin',
  templateUrl: './edit-salloncoin.component.html',
  styleUrls: ['./edit-salloncoin.component.css']
})
export class EditSalloncoinComponent implements OnInit {
  addForm!: FormGroup; 
  categList:any=[];
  id!:number; 
  produit:any={};

...
@Component({
  selector: 'app-list-fautteil',
  templateUrl: './list-fautteil.component.html',
  styleUrls: ['./list-fautteil.component.css']
})
export class ListFautteilComponent implements OnInit {
  produitList:any=[];
  userId!:number ; 
  user:any; 

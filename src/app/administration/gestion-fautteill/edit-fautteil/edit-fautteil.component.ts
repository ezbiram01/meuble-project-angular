...
@Component({
  selector: 'app-edit-fautteil',
  templateUrl: './edit-fautteil.component.html',
  styleUrls: ['./edit-fautteil.component.css']
})
export class EditFautteilComponent implements OnInit {
  addForm!: FormGroup; 
  categList:any=[];
  id!:number; 
  produit:any={};

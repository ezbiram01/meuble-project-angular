...
@Component({
  selector: 'app-add-fautteil',
  templateUrl: './add-fautteil.component.html',
  styleUrls: ['./add-fautteil.component.css']
})
export class AddFautteilComponent implements OnInit {
  addForm!: FormGroup; 
  categList:any=[];

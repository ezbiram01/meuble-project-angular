...
@Component({
  selector: 'app-list-consolc',
  templateUrl: './list-consolc.component.html',
  styleUrls: ['./list-consolc.component.css']
})
export class ListConsolcComponent implements OnInit {
  produitList:any=[];
  userId!:number ; 
  user:any; 

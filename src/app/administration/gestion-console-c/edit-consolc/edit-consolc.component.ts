...
@Component({
  selector: 'app-edit-consolc',
  templateUrl: './edit-consolc.component.html',
  styleUrls: ['./edit-consolc.component.css']
})
export class EditConsolcComponent implements OnInit {
  addForm!: FormGroup; 
  categList:any=[];
  id!:number; 
  produit:any={};

...
@Component({
  selector: 'app-list-consol-m',
  templateUrl: './list-consol-m.component.html',
  styleUrls: ['./list-consol-m.component.css']
})
export class ListConsolMComponent implements OnInit {
  produitList:any=[];
  userId!:number ; 
  user:any; 

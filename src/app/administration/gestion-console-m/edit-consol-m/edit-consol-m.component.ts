...
@Component({
  selector: 'app-edit-consol-m',
  templateUrl: './edit-consol-m.component.html',
  styleUrls: ['./edit-consol-m.component.css']
})
export class EditConsolMComponent implements OnInit {
  addForm!: FormGroup; 
  categList:any=[];
  id!:number; 
  produit:any={};

...
@Component({
  selector: 'app-add-consol-m',
  templateUrl: './add-consol-m.component.html',
  styleUrls: ['./add-consol-m.component.css']
})
export class AddConsolMComponent implements OnInit {
  addForm!: FormGroup; 
  categList:any=[];

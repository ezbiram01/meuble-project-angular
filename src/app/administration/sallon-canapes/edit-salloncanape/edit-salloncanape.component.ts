...
@Component({
  selector: 'app-edit-salloncanape',
  templateUrl: './edit-salloncanape.component.html',
  styleUrls: ['./edit-salloncanape.component.css']
})
export class EditSalloncanapeComponent implements OnInit {
  addForm!: FormGroup; 
  categList:any=[];
  id!:number; 
  produit:any={};

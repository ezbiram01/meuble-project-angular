...
@Component({
  selector: 'app-list-salloncanape',
  templateUrl: './list-salloncanape.component.html',
  styleUrls: ['./list-salloncanape.component.css']
})
export class ListSalloncanapeComponent implements OnInit {

...
@Component({
  selector: 'app-add-salloncanape',
  templateUrl: './add-salloncanape.component.html',
  styleUrls: ['./add-salloncanape.component.css']
})
export class AddSalloncanapeComponent implements OnInit {
  addForm!: FormGroup; 
  categList:any=[];
